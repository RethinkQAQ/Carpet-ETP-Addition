...
public class CrafterBlockMixin {
    ...
    private boolean isReceivingRedstonePower(Level world, BlockPos blockPos, Operation<Boolean> original) {
        return world.hasNeighborSignal(blockPos) || (world.hasNeighborSignal(blockPos.above()) && CarpetETPSettings.CrafterCanQC);
    }
}
